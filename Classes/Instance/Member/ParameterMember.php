 ...
 */
class ParameterMember extends \Classes\Instance\Instance {
   /*
    ...
    protected $validPropertyNames = array(
        ...
        'sectionProperty' => '\Classes\Value\StringValue',
        'E' => '\Classes\Value\FloatValue',
        'nu' => '\Classes\Value\FloatValue',
        'density' => '\Classes\Value\FloatValue',
        'tmp' => '\Classes\Value\FloatValue',

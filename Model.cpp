...
this->members.push_back(Member(5, "B2", 4, 10, 0, 0, 0, "STZ RUSSIAN p_norm_b 14 TMP 1.2e-005"));
...
this->members.push_back(Member(11, "B2", 10, 2, 0, 32, 0, "STZ RUSSIAN p_norm_b 14 TMP 1.2e-005"));
// +++ RESTRAINTS +++
